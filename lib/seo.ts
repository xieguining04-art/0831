...
export const siteOrigin = process.env.NEXT_PUBLIC_SITE_ORIGIN || "https://tengyoda-premium-preview.xieguining04.chatgpt.site";
...
export type PageSeo = {
  ...
  primary: string;
  longTail: string[];
  content: Record<Language, SearchCopy>;
  guideSlug: string;
};

export const homeSeo = {
  title: "China Freight Forwarder | Global Sea Freight | TengYoda",
  description: "Global sea freight booking from China, focused on Oceania, Africa and South America. Plan FCL and LCL shipping with pickup and consolidation support.",
...
export const serviceSeo: Record<string, PageSeo> = {
  "freight-forwarding": {
    ...
    content: {
      ...
      "zh-CN": { h1: "中国出口物流，衔接起运端每一步。", intro: "中国出口物流需要衔接供应商、境内运输、仓库操作和国际订舱。TengYoda 为海外进口商协调中国端交接，以明确的责任范围、运输计划和专人联系推进货物发运。", questions: [
        { question: "能否由同一个团队协调供应商提货与国际运输？", answer: "可组合协调中国端各环节，也可单独提供服务。请提供供应商位置、备货日期与目的地，以确认报价包含的提货、仓库和国际运输工作。" },
        { question: "中国出口物流报价应包含哪些信息？", answer: "建议分别列明提货范围、起运端操作、国际运输和目的地服务，确认不含项目、单证责任及各环节交接人。" },
      ] },
    },
  },
  "sea-freight": {
    title: "Sea Freight from China: FCL & LCL Shipping | TengYoda",
    description: "Book FCL and LCL sea freight from China worldwide. Our focus trade lanes are Oceania, Africa and South America, with origin pickup and consolidation support.",
    ...
    content: {
      en: { h1: "Sea freight from China: FCL and LCL shipping.", intro: "Global sea freight booking is TengYoda's main service. Our focus trade lanes are China to Oceania, Africa and South America, including Australia and New Zealand within Oceania. We coordinate FCL and LCL bookings, origin collection and warehouse consolidation around your cargo volume, ready date and destination. Other worldwide destinations can also be assessed.", questions: [
        { question: "Which trade lanes do you focus on for sea freight from China?", answer: "Our focus trade lanes are Oceania, Africa and South America. Share the destination port, cargo details and ready date for an FCL or LCL assessment. Specific sailings, carrier acceptance and destination handling are confirmed for each booking; a regional focus does not imply every port has a direct sailing." },
      ...
      "zh-CN": { h1: "中国发往全球海运：整柜与拼箱订舱。", intro: "全球海运订舱是 TengYoda 的主营业务，优势航线为中国至大洋洲、非洲和南美，其中大洋洲包括澳大利亚和新西兰。根据货量、备货日期与目的地协调整柜（FCL）、拼箱（LCL）、提货及仓库集运，其他全球目的地也可按需咨询。", questions: [
        { question: "中国始发海运的优势航线有哪些？", answer: "我们的优势航线为大洋洲、非洲和南美。请提供目的港、货物资料和备货日期，以评估整柜或拼箱方案。具体船期、承运条件与目的地操作按每票货物确认；区域航线优势不代表所有港口均有直航。" },
        { question: "中国始发整柜海运询价需要哪些资料？", answer: "请提供包装尺寸、毛重、备货日期、提货地址、目的港或派送地址，如已确定柜型也请注明。比较报价时，应同时核对起运地与目的地费用，而不只比较海运费。" },
      ] },
    },
  },
  "air-freight": {
    ...
    content: {
      ...
      "zh-CN": { h1: "中国始发国际空运，服务有时效要求的货物。", intro: "在符合空运承运条件的前提下，国际空运可用于紧急订单、替换零件及较高价值货物。TengYoda 综合核对包装信息、目的地、工厂提货、机场交接及所需后续派送。", questions: [
        { question: "中国到澳大利亚空运询价需要哪些资料？", answer: "请提供品名、件数、包装外尺寸、毛重、备货日期和目的机场或邮编。电池、液体等特殊成分需提前说明。报价应区分机场费用与末端派送服务。" },
        { question: "中国出口急货如何选择空运和快递？", answer: "按相同货物和交付范围比较。较小包裹可评估快递，较大且有时效要求的货物可同时评估空运。最终选择取决于承运条件、操作安排、计费重和完整交付计划。" },
      ] },
    },
  },
  "international-express": {
    ...
    content: {
      ...
      "zh-CN": { h1: "中国始发国际快递：DHL、FedEx 与 UPS 方案。", intro: "为在中国提取的产品样品、包裹及较小订单提供国际快递询价。TengYoda 根据实际货物资料比较 DHL、FedEx 与 UPS 服务，发运前确认服务可用性和承运条件。", questions: [
        { question: "能否通过 DHL、FedEx 或 UPS 寄送中国采购样品？", answer: "请提供样品说明、供应商地址、包装尺寸、重量与收件邮编，并说明是否含电池、液体等特殊成分。具体服务需核对货物及目的地后确认。" },
        { question: "如何比较中国发往海外的国际快递报价？", answer: "使用相同的包裹尺寸和目的地资料，核对计费重、提货范围、操作或派送附加费用及目的地责任。不能默认快递运费包含全部进口费用。" },
      ] },
    },
  },
  "china-import-export": {
    ...
    guideSlug: "buying-from-china-checklist",
    content: {
      en: { h1: "China procurement and sourcing support for overseas buyers.", intro: "Connect China procurement with the shipment plan from the start. From our Foshan operations base, TengYoda supports supplier coordination, order follow-up and export preparation, with warehouse consolidation available for purchases from multiple suppliers.", questions: [
      ...
      "zh-CN": { h1: "面向海外采购商的中国采购与供应商协调。", intro: "在中国采购初期同步规划运输。TengYoda 以佛山运营网点为基础，支持供应商协调、订单跟进与出口准备，并可为多家供应商采购安排仓库集运。", questions: [
        { question: "能否将中国采购与国际运输纳入同一方案？", answer: "请提供产品规格、供应商资料、数量和目的地，可一起评估采购协调与运输工作。家具、灯具或建筑材料订单应尽早提供包装信息，使运输计划符合实际交运状态。" },
        { question: "向多家中国供应商采购前应确认哪些事项？", answer: "分别确认规格、数量、订单编号及备货日期。送至集运仓前约定收货唛头与核对要求，并以书面形式明确采购责任和物流服务范围。" },
      ] },
    },
  },
  "transport-warehousing": {
    ...
    guideSlug: "buying-from-china-checklist",
    content: {
      en: { h1: "China domestic trucking and factory pickup.", intro: "Move export cargo between Chinese factories, receiving warehouses, ports and airports. TengYoda coordinates domestic road transport with the receiving window and international booking plan, using the actual cargo size, loading conditions and collection address.", questions: [
      ...
      "zh-CN": { h1: "中国境内陆运与工厂提货服务。", intro: "衔接中国工厂、收货仓库、港口与机场之间的出口货物运输。TengYoda 根据实际货物尺寸、装卸条件和提货地址，将国内陆运与仓库收货窗口、国际订舱计划相协调。", questions: [
        { question: "能否从中国工厂提货并送到集运仓？", answer: "请提供提送货地址、供应商联系方式、包装资料和可装货日期，以评估工厂到仓库的运输，并在订车前与相应仓库确认收货要求。" },
        { question: "中国境内拖车或陆运报价范围受哪些因素影响？", answer: "需核对运输距离、车辆要求、货物尺寸和重量、装卸通道及送货时间，明确装卸设备由谁提供，以及仓库、港口或机场是否需要预约。" },
      ] },
    },
  },
  "cargo-consolidation": {
    ...
    content: {
      ...
      "zh-CN": { h1: "中国货物集运：多供应商订单统一发运。", intro: "通过中国仓库集运，将多家供应商订单衔接为统一出口计划。TengYoda 在青岛、义乌和深圳提供收货网点支持；供应商发货前需确认具体收货仓库和订单标识。", questions: [
        { question: "如何将多家中国供应商的货物合并运输？", answer: "准备供应商清单、订单编号、预计到仓时间与包装资料，提前约定收货要求和核对范围。所需货物到齐后，按最终尺寸重量比较空运、海运拼箱或整柜方案。" },
        { question: "义乌集运仓和深圳集运仓应如何选择？", answer: "结合供应商地址、备货日期和出口路线选择，而不只看城市名称。可联系 TengYoda 评估青岛、义乌和深圳收货安排，送货前由 Vinson 确认地点、预约及唛头。" },
      ] },
    },
  },
  "oversize-freight": {
    ...
    content: {
      ...
      "zh-CN": { h1: "中国始发超大货物与重型机械运输。", intro: "通过设备与线路评估，为机械和非标准货物安排中国始发运输。TengYoda 根据各件货物的运输尺寸、重量、吊点和操作限制，协调提货与出口方案。", questions: [
        { question: "从中国运输重型机械需要准备哪些资料？", answer: "请提供型号、运输尺寸、重量、照片、吊点及装卸设施信息。挖掘机或移动设备需说明能否自行移动，以及哪些部件可拆卸后运输。" },
        { question: "超大设备是否一定要使用特种集装箱？", answer: "具体方式取决于货物和设备情况，可评估标准或特种设备、滚装或散杂货运输。订舱前需要确认线路可行性、加固安排及承运条件。" },
      ] },
    },
  },
  "roro-project-cargo": {
    ...
    content: {
      ...
      "zh-CN": { h1: "中国始发滚装运输与项目货物物流。", intro: "根据具体线路，为中国出口车辆、移动设备和项目货物协调运输计划。TengYoda 先核对设备状态、港口交接和承运条件，再评估滚装或其他运输安排。", questions: [
        { question: "中国出口车辆和移动机械可以采用滚装运输吗？", answer: "货物状态、操作方式和可用船舶服务合适时，可以评估滚装方案。请提供尺寸、重量、运行状态和目的地，确认具体设备的承运要求后再安排发运。" },
        { question: "中国始发项目货物或散杂货如何规划？", answer: "先准备逐件货物清单、图纸、吊装信息和目的地交接要求，各阶段需匹配装载、运输和收货条件。TengYoda 协调中国端计划，并明确目的地合作伙伴负责的范围。" },
      ] },
    },
  },
};
...
export function pageMetadata(title: string, description: string, path: string): Metadata {
  const canonicalPath = process.env.NEXT_PUBLIC_STATIC_EXPORT === "1" && !path.endsWith("/") ? `${path}/` : path;
  return { title, description, alternates: { canonical: `${siteOrigin}${canonicalPath}` } };
}
